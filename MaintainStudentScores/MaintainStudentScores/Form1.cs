...
{
    private List<Student> students = new List<Student>(); // initializing a student object
    public Form1()
    {
        InitializeComponent();
    }
    ...
    {
        UpdateStudent updateStudent = new UpdateStudent(); // create a new UpdateStudent form window
        updateStudent.ShowDialog(); // open the UpdateStudent form window
    }
